...
using Net.Glow.Studios.Infrastructure.Exceptions;
...
public abstract class BaseRepositoryAsync<T>(ApplicationDbContext applicationDbContext) : IBaseRepositoryAsync<T>, IBaseRepositoryReadOnlyAsync<T> where T : BaseEntity
{
