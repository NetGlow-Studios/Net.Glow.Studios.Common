...
public class BaseRepositoryReadOnlyAsync<T> : IBaseRepositoryReadOnlyAsync<T> where T : BaseEntity
{
    private readonly DbSet<T> _dbSet;
    private readonly ApplicationDbContext _applicationDbContext;

    protected BaseRepositoryReadOnlyAsync(ApplicationDbContext applicationDbContext)
    {
