...
public class BaseRepositoryReadOnly<T> : IBaseRepositoryReadOnly<T> where T : BaseEntity 
{
    private readonly DbSet<T> _dbSet;
    private readonly ApplicationDbContext _applicationDbContext;

    protected BaseRepositoryReadOnly(ApplicationDbContext applicationDbContext)
    {
