...
using Ngs.Common.AspNetCore.Infrastructure.SqLite.Extensions;

namespace Ngs.Common.AspNetCore.Infrastructure.SqLite.Configuration;

/// <summary>
/// Base entity configuration
/// </summary>
/// <typeparam name="TBase"> Base entity type </typeparam>
public abstract class BaseSqliteEntityConfiguration<TBase> : IEntityTypeConfiguration<TBase> where TBase : BaseEntity
{
    /// <summary>
